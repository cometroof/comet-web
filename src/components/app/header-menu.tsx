  ...
  return (
    <div className="header-menu group isClosed" id="burger-menu">
      <div className="outer-wrapper h-full relative">
        ...
        <div className="absolute bottom-0 right-0 overflow-hidden  text-primary  transition-all delay-200 translate-y-20 opacity-0 group-[.isOpen]:opacity-100 group-[.isOpen]:translate-y-0">
